...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TablaDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IDPROD", "NOMBRE", "CATEGORIA", "ESTADO"
            }
        ));
    ...
    private void TablaDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDatosMouseClicked
        ...
        if (row == -1) {
            ...
            String cat = (String) TablaDatos.getValueAt(row, 2);
            String est = (String) TablaDatos.getValueAt(row, 3);
            txtId.setText("" + id);
            txtNom.setText(nom);
            txtCat.setText(cat);
            txtEst.setText(est);
    ...
    void listar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                producto[3] = rs.getString("estado");
    ...
    void Agregar() {
        ...
        try {
            if (nom.equals("") || cat.equals("") || est.equals("")) {
                JOptionPane.showMessageDialog(null, "Debe Ingresar Datos");
                limpiarTabla(model);
            } else {
                String sql = "insert into producto(nombre,categoria,estado) values('" + nom + "','" + cat + "','" + est + "')";
                con = cn.getConnection();
                st = con.createStatement();
    ...
    void Modificar() {
        ...
        String cat = txtCat.getText();
        String est = txtEst.getText();
        String sql = "update producto set nombre='" + nom + "',categoria='" + cat + "',estado='" + est + "' where idProducto=" + id;
        try {
            if (nom != null || cat != null || est != null) {
                con = cn.getConnection();
                st = con.createStatement();
                st.executeUpdate(sql);
